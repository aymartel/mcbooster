...
import product1 from "@/images/shop/product1.jpg"
import product2 from "@/images/shop/product2.jpg"
import product3 from "@/images/shop/product3.jpg"
import product4 from "@/images/shop/product4.jpg"
    ...
    <Fragment>
      ...
      <div className="row shop-active">
        ...
        <div className="col-xl-4 col-md-6 item saas ui-kits dashboard">
          <div className="product-item wow fadeInUp delay-0-6s">
            <div className="image">
              <Image   src={product9}  alt="Product" />
            </div>
            <div className="content">
